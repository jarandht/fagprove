...
### Delvis fulført:
1. [Gi lærar tilgong til å administrere elevar](UtfortArbeid/Sky/Administasjon/Brukere/NyeBrukarar.md)
    * Manglar script for å legge brukara inn i AU og i security gruppe, dette må gjerast via ein API, treng meir arbeid.


### Utfordringar:

1. Ny unplanlagt arbeidsoppgåve, la lærara administrere elevar sine påloggingsalternativ
...
### Delvis utført:
1. [Autopilot](UtfortArbeid/Sky/Administasjon/Maskinvare/Windows/Autopilot.md)
    * Autopilot eller PC funkar ikkje slik det skal, innrulleringa startar ikkje

### Utfordringar:
1. Dårleg nett
1. Sikkring i lab gjikk
1. Autopilot eller PC funkar ikkje slik det skal
...
1. [VG testen](UtfortArbeid/OnPrem/Brannmur/VGTesten.md)
    * Krever prøving å feiling, dette gjer at det tar lang tid å blir gjort etterkvart
1. [Konfigurasjon av Veeam](UtfortArbeid/OnPrem/Serverar/Backup/VeeamInnstalasjon.md)
    * Tar lang tid

### Utfordringar:
1. Brannmuren er ekstremt treg (dette er vanleg)
1. Problem med brannmur som ikkje fonka slik som den skulle
1. Sikkring i lab gjikk førte til att lagringsclusteret i laben til serverane som er i bruk
...
### Delvis utført:
1. [Konfigurasjon av Veeam](UtfortArbeid/OnPrem/Serverar/Backup/VeeamInnstalasjon.md)
    * Tar lang tid (Måtte nådde ikkje nudvendige resursar i proxmox) trengte prøving og feiling i treg brannmur.
1. [Print](UtfortArbeid/OnPrem/Print/Print.md)

### Utfordringar:
1. Brannmuren er ekstremt treg (dette er vanleg)
1. Print var dårleg dokumentert hjå leverandør og dokumentasjonen stemte ikkje